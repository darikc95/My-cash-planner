            ...
            child: ListView(
              ...
              children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.person_rounded,
                              size: 28, color: Color(0xFF6C45E3)),
                        ),
                ...
                _ProfileActionTile(
                  ...
                  title: 'Личные данные',
                  onTap: () =>
                      _handleProfileAction(context, 'Редактирование профиля'),
                ),
                _ProfileActionTile(
                  icon: Icons.lock_outline_rounded,
                  title: 'Безопасность',
                  onTap: () =>
                      _handleProfileAction(context, 'Настройки безопасности'),
                ),
                _ProfileActionTile(
                  icon: Icons.notifications_none_rounded,
                  title: 'Уведомления',
                  onTap: () => _handleProfileAction(
                      context, 'Настройки уведомлений профиля'),
                ),
                _ProfileActionTile(
                ...
                FilledButton(
                  onPressed: () => context.go(ExpenseUiRoutes.login),
